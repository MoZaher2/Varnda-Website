...
import "./AddHomePropertyPage.css"
const AddHomePropertyPage = () => {
                      ...
                      {formData.adGoal !== 'rent' ? (
                        ...
                        (
                          <>
                            ...
                            <Form.Group controlId="unitPricePer" className="mb-3">
                              <Form.Label>سعر المعروض في </Form.Label>
                              <Form.Select
                                name="unitPricePer"
                                value={formData.unitPricePer}
                                onChange={handleChange}
                                required
                              >
                                <option value="">اختر</option>
                                <option value="day">اليوم</option>
                                <option value="weak">الاسبوع</option>
...
export default AddHomePropertyPage;
