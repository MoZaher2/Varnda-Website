    ...
    <>
      ...
      <Container>
        ...
        <Row className="my-5">
          ...
          <p dir="rtl" className=" my-4 about-text">قيمنا نحن هنا فى فرندا حريصين على تلبية احتياجات كل من المواطنين و الوافدين من كل أنحاء العالم لتسهيل عملية البحث عن العقارات في المنطقة، قدرنا نحقق ده من خلال دراسة السوق على نطاق واسع و ركزنا على إيجاد حلول تسهل على الباحثين عن عقارات إيجاد كل ما يناسبهم سواء أفراد أو وكلاء. شركتنا تتبنى قيم أساسية زي المصداقية والابتكار وتحمل المسئولية الكاملة في تحقيق احتياجات العملاء وهدفنا الأساسي هو الإرتقاء بمستوى السوق في المنطقة.</p>
