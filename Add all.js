...
const AddApartmentsAndDuplexesPage = () => {
  ...
  const [primary_picture, setPrimary_picture] = useState(null);//API for main image
    ...
    if (form.checkValidity() === false || !formData.primary_picture) {
      ...
      try {
        ...
        for (const [key, value] of Object.entries(formData)) {
          // if(key==="primary_picture"||key==="images[]"){}
          // else{
        ...
        if (primary_picture) {
          // console.log("csdsdsdsdsdب");
          // console.log(formData.primary_picture[0]);
